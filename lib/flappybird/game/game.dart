...
class FlutterBirdGame extends BaseGame {
  ...
  void gameOverAction() {
    if (status != GameStatus.gameOver) {
      ...
      pushScoreToFirebase(_scorer.getScore());
    }
  }
  
  
  void pushScoreToFirebase(int score) async {
    /* added */
    _firebaseAuth = FirebaseAuth.instance;
    _firebaseUser = await _firebaseAuth.currentUser();
    http.get("https://us-central1-poem-5a71c.cloudfunctions.net/updateHighScore?uid=${_firebaseUser.uid}&newScore=${score}");
  }
